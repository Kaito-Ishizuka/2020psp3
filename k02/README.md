...
## ソースコードの説明
l79新しいNode用のメモリを取る
l80~l81リストの先頭に新しいデータを入れる

l92~l93先頭の要素の前に要素を追加して前の要素として使う
l94全部の要素にループを回す
l97削除する要素のメモリを解放
l99　l92~l93でもともと先頭にあった要素を最初に持ってくる
l103ここに到達したらERRORを返す

l121~128 idをリストのデータと比較して一致すれば市町村データを返す
l129次の要素にアクセス
## 出力結果
