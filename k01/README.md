...
## ソースコードの説明
l72 最初の要素のインデックスから最後まで繰り返す
l74~77 要素のidがkeyと一致したらそのインデックスを返して処理を終了する
l79 配列の中にkeyのidがなかった場合-1を返す

l90 leftとrightの間に要素があるとき繰り返す
l93~96 探しているidのデータが真ん中にあった場合そのデータのインデックスを返す
l97~100 真ん中のidがkeyよりも小さいとき探している要素は真ん中よりも右側にあるからleftを書き換える
l102~105 真ん中のidがkeyよりも大きいとき探している要素は真ん中よりも左側にあるからrightを書き換える
l108 配列の中にkeyのidがなかった場合-1を返す
